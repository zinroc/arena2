...
module.exports = function (knex) {
    ...
    return {
        ...
        /**
        *   Called by client in /encounter
        */
        getElderInfo:function (email, encounter) {
            var elderInfo = null;
        ...
        *   Called by client
        */
        getCharacterInfo: function(email, char_id){
            var character = {};
            ...
            }).then(function (charEncounterInfoRows){
                character.cardInfo = charEncounterInfoRows[0];
                return character;
            });
        },
        /**
        ...
        */  
        generateEncounter: function (email, char_id, elder_id, region, encounter_name){
            return knex("characters")
            .select("*")
            .where({owner: email, id: char_id})
            .then(function (rows){
                ...
                if(!cards){
                    ...
                    return knex("encounters")
                        .insert({card_1: cards[0], card_2: cards[1], card_3: cards[2], card_4: cards[3], card_5: cards[4], elder_id: elder_id, region: region, encounter_name: encounter_name})
                        .returning("id")
        ...
        */
        deletePlayerCharacter: function (email, id){
            ...
            .then(function (characters){
                ...
                return knex("encounter_elders")
                .where({encounter: character.encounter})
                .del();
            }).then(function (){
                return knex("encounters")
                .where({id: character.encounter})
                .del();
            }).then(function (){
                return knex("characters")
                .where({owner: email, id: id})
