...
module.exports = function (knex) {
    ...
    return {
        ...
        */  
        generateEncounter: function (email, char_id){
            ...
            .then(function (rows){
                ...
                return knex("encounter")
                    .insert({card_1: cards[0], card_2: cards[1], card_3: cards[2], card_4: cards[3], card_5: cards[4]})
                    .returning("id")
                ...
                if (!cards){
                    ...
                    .insert({encounter: cards.id, encounter_characters: char_id, card_1: cards[5], card_2: cards[6]})
                    .then(function (){
                        return cards;
                    });
                }
